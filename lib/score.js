exports.get_score = function(lastDelta,delta,T,multiplier){
    Number.prototype.mod = function(n){
	return ((this%n)+n)%n;
    }
    
    function get_player_tempo(T,lastDelta,delta){
	var avgDelta = lastDelta+delta/2.
	return 60.*1000./(avgDelta);
    }
